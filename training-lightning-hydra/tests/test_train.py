...
@pytest.mark.slow
@pytest.mark.xfail(reason="PyTorch 2.6+ weights_only=True default breaks checkpoint loading in ddp_spawn child processes (can't patch globals across spawn boundary)")
